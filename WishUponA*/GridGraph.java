...
public class GridGraph {
	...
	public void addGridNode(final int x, final int y, final String nodeName){
		...
		for(GridNode g: nodeList){
			if((g.x_coord == (gridNode.x_coord -1) && g.y_coord == gridNode.y_coord )|| (g.x_coord == (gridNode.x_coord+1) && g.y_coord == gridNode.y_coord) 
					|| (g.y_coord == (gridNode.y_coord -1) && g.x_coord == gridNode.x_coord) || (g.y_coord == (gridNode.y_coord+1) && g.x_coord == gridNode.x_coord)){
				gridNode.neighbors.add(g);
				g.neighbors.add(gridNode);  
			}
		}
	}
